...
async function seed() {
  ...
  const usersData = [
    ...
    },
    {
      ...
      employeeId: "FAC-SOM-102",
      phoneNumber: "9823456789",
      bio: "Assistant Professor, Management Studies. Awaiting dean portal approval.",
    ...
    },
    {
      ...
      rollNumber: "AP21IT042",
      phoneNumber: "9845678901",
      bio: "4th Year IT. Vice-President of Cultural Events Committee.",
      onboardingCompleted: true,
    },
    {
      uid: "usr_student_003",
      ...
      rollNumber: "AP22BT015",
      phoneNumber: "9856789012",
      bio: "3rd Year Biotech. Student coordinator for Science Symposiums.",
      onboardingCompleted: true,
    },
    {
      uid: "usr_student_004",
      ...
      status: "ACTIVE" as const,
      department: "School of Management",
      rollNumber: "AP22MB008",
      phoneNumber: "9867890123",
      bio: "2nd Year MBA. Coordinator for Management Conclaves.",
      onboardingCompleted: true,
    },
    {
      uid: "usr_student_005",
      ...
      role: "student" as const,
      status: "ACTIVE" as const,
      department: "Healthcare & Hospital Administration",
      rollNumber: "AP23HA021",
      phoneNumber: "9878901234",
      bio: "1st Year MHA. Enthusiastic participant in campus sports.",
      onboardingCompleted: true,
    },
  ];
  ...
  const registrationsData = [
    ...
    },
    {
      ...
      userRollNumber: "AP22MB008",
      userDepartment: "School of Management",
      status: "CONFIRMED" as const,
