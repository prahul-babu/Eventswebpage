              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-3 text-xs">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-slate-700 truncate" title={`${department} • ${school}`}>{department} &bull; {school}</div>
                  </div>
                </div>
              </div>

              {/* Notification Notice Box */}
              <div className="p-3.5 rounded-xl bg-[#E0F3F7]/70 border border-[#B2E3EC] flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-[#007A99] shrink-0 mt-0.5" />
