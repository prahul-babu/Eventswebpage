...
export function generateEventReportPdf(report: EventReport): jsPDF {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ["NAAC Criterion", report.institutionalMapping.naacCriterion || "Criterion 1: Curricular Aspects"],
      ...
      ["Certificates Issued", `${report.institutionalMapping.certificatesIssuedCount} E-Certificates verified`],
    ],
    theme: "grid",
    headStyles: { fillColor: [49, 46, 129], fontSize: 8 },
    bodyStyles: { fontSize: 8 },
