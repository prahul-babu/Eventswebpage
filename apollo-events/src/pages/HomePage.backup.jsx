...
<div className="rounded-2xl bg-apollo-navy p-6 sm:p-8 text-white">
  <div className="max-w-3xl">
    <p className="text-xs font-bold uppercase tracking-widest text-apollo-gold mb-2">
    ...
    <p className="mt-3 text-sm text-white/80 leading-relaxed">
      Explore workshops, hackathons, seminars, conferences and other
      activities happening across The Apollo University.
    </p>

    <Link
      to="/events"
      className="inline-flex items-center gap-2 mt-5 px-5 py-2.5 rounded-xl bg-apollo-gold text-apollo-dark font-bold text-sm hover:opacity-90 transition-opacity"
    >
      Explore All Events
